...
const imgWorldMap = '/images/world-map.svg'
const imgLocationIcon1 = '/images/location-icon-1.svg'
const imgLocationIcon2 = '/images/location-icon-2.svg'
...
export function GlobalCampuses({ locale }: GlobalCampusesProps) {
  ...
  return (
    <section className="flex flex-col gap-20 items-center justify-start px-12 py-24 w-full max-w-[1440px] mx-auto">
      {/* Title */}
      <div className="flex flex-col gap-2.5 items-start justify-start w-full">
        <h1 className="font-eb-garamond font-normal text-[44px] leading-[1.2] tracking-[-1.32px] text-[#111111] w-full">
          <span>
            Explore Our Campuses <br />
          </span>
