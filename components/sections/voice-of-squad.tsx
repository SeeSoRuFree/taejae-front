      ...
      <div className="mx-auto px-4" style={{ maxWidth: `${MAX_CONTENT_WIDTH}px` }}>
        <div className="mb-12 flex justify-between items-end">
          <div className="max-w-[960px]">
            <h2
              data-key="voice-of-squad-title"
              className="text-5xl md:text-6xl font-medium leading-tight mb-4 font-['Instrument_Sans'] tracking-[-3.2px]"
            >
              The Voice of Taejae Squad
            </h2>
            <p
              data-key="voice-of-squad-subtitle"
              className="text-xl text-gray-600 font-['Instrument_Sans']"
            >
